...
def get_site_config(sites_path: str | None = None, site_path: str | None = None) -> dict[str, Any]:
	...
	if site_path:
		...
		if os.path.exists(site_config):
			...
			# Datahenge - If the site does not exist, tell the developer where Frappe was looking for it.  Helps with troubleshooting
			absolute_site_path = pathlib.Path(site_path).absolute()
			print(f"Error: Cannot find this path: {absolute_site_path}")
