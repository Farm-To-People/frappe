...
class BaseDocument:
	...
	def is_new(self) -> bool:
		return bool(self.get("__islocal"))  # Datahenge: Enforce that boolean type.
	...
	def show_unique_validation_message(self, e):
		if frappe.db.db_type != "postgres":
			...
			# Datahenge: One problem with calling msgprint() before the Exception,
			# is now we cannot suppressby catching in an outer exception.
