...
# Datahenge - Adding a new key 'dh_dynamic_link_map'
global_cache_keys = ("app_hooks", "installed_apps", 'all_apps',
		...
		'sitemap_routes', 'db_tables', 'server_script_autocompletion_items', 'dh_dynamic_link_map') + doctype_map_keys,  # DH, please note trailing comma
...
def clear_user_cache(user=None):
	...
	if user:
		...
		# clear_global_cache()  # DATAHENGE: I don't see any reason for the 'clear_user_cache()' method to screw around with the Global Cache
